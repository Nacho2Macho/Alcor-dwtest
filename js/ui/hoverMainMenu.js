...
//     $('.main__menu-item:not(:first) .main__menu-text').hide();
...
//       $('.main__menu-item .main__menu-text').stop().fadeOut(300);
//       $(this).find('.main__menu-text').stop().fadeIn(300);
...
//           $(this).find('.main__menu-text').stop().fadeOut(300);
//         }
//       }
//     );
...
//         firstMenuItem.addClass('active');
//         firstMenuItem.find('.main__menu-text').stop().fadeIn(300);
//         $('.main__slide-wrapper').hide();
//         $('.main__slide-wrapper[data-tab="' + firstTabId + '"]').show();
//       }
//     });
...
$(document).ready(function () {
    ...
    $('.main__menu-item').hover(
        function () {
            $(this).addClass('hover');
            $(this).find('.main__menu-text').fadeIn(300);
        },
        function () {
            $(this).removeClass('hover');
            if (!$(this).hasClass('active')) {
                $(this).find('.main__menu-text').fadeOut(300);
            }
        }
    );
